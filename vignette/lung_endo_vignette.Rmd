...
Download the CellRef [cell type dictionary for lung endothelial cells](https://github.com/xu-lab/CellRef/raw/main/data/Lung_endothelial_ctd.rds) and load the dictionary into R. We assume that the dictionary is a data.frame that contains at least three columns: CellType, Marker, and MarkType (p - positive marker, n - negative marker).
